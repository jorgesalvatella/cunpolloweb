  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-red-600 text-white py-4 rounded-full font-bold text-lg hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
      >
        {loading ? t("processing") : `${t("pay")} $${total} MXN`}
      </button>

      <p className="text-center text-dark/40 text-xs flex items-center justify-center gap-1.5">
