            ...
            <div className="flex flex-wrap gap-3">
              ...
              {FEATURES.REWARDS_ENABLED && (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-5 py-2.5 border border-gold-400/40 text-gold-400 font-semibold rounded-full text-sm hover:bg-gold-400/10 transition-colors"
                >
