      ...
      <Container className="relative z-10">
        <div className="text-center max-w-2xl mx-auto px-2">
          ...
          >
            <Link
              href="/menu"
              className="inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-4 bg-white text-red-600 font-semibold rounded-full text-base sm:text-lg hover:bg-white/90 transition-all shadow-lg"
            >
              {t("button")}
            </Link>
            <a
              href={`tel:${RESTAURANT.phone}`}
              className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 border-2 border-white text-white font-semibold rounded-full text-base sm:text-lg hover:bg-white/10 transition-all"
            >
