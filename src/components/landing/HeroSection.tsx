        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="max-w-2xl lg:flex-1">
            <motion.div
              ...
              className="inline-block mb-4 sm:mb-6 px-4 sm:px-6 py-2 sm:py-2.5 bg-gold-500 rounded-full shadow-lg"
            >
              <span className="text-white font-bold text-xs sm:text-base md:text-lg tracking-wide">
                {t("playArea")}
              </span>
            </motion.div>
            ...
            >
              <Link
                href="/menu"
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-4 bg-white text-red-600 font-bold rounded-full text-base sm:text-lg hover:bg-gold-300 hover:text-red-700 transition-all shadow-lg hover:shadow-xl"
              >
                {t("cta")}
              </Link>
              <a
