      ...
      <Container>
        ...
        {items.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-white/50 text-lg mb-6">{t("empty")}</p>
            <Link
              href="/menu"
          ...
          <>
            ...
            <div className="bg-surface-2 border border-white/10 rounded-2xl p-6 mb-6">
              ...
              <div className="flex justify-between items-center text-xl font-bold border-t border-white/10 pt-3">
                <span>{t("total")}</span>
                <span className="text-gold-400">${total} MXN</span>
              </div>
            </div>
            ...
            {FEATURES.REWARDS_ENABLED && (
              <a
                ...
                className="flex items-center gap-4 bg-gold-500 rounded-2xl px-5 py-4 mb-4 hover:bg-gold-400 transition-colors shadow-md group"
              >
                <div className="w-10 h-10 bg-dark/15 rounded-xl flex items-center justify-center shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-dark font-bold text-sm">{tRewards("cartNote")}</p>
                </div>
                <div className="px-4 py-2 bg-dark text-gold-400 text-sm font-bold rounded-full shrink-0 group-hover:bg-dark-800 transition-colors shadow-sm">
            ...
            <div className="flex flex-col gap-3">
              <Link
                href="/checkout"
                className="text-center bg-red-600 text-white px-6 py-4 rounded-full font-bold text-lg hover:bg-red-500 transition-colors shadow-lg shadow-red-600/25"
              >
                {t("checkout")}
              </Link>
              <div className="flex items-center justify-center gap-4">
                <Link
                  href="/menu"
                  className="text-red-300 font-medium hover:text-red-400 transition-colors text-sm"
                >
                  {t("continueShopping")}
                </Link>
                ...
                <button
                  onClick={clearCart}
                  className="text-red-300 hover:text-red-400 transition-colors text-sm cursor-pointer"
                >
                  {t("clearCart")}
                </button>
              </div>
