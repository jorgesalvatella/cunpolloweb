          ...
          <>
            ...
            {FEATURES.REWARDS_ENABLED && (
              <a
                ...
                className="flex items-center gap-3 bg-gold-500/10 rounded-xl px-4 py-3 mb-4 hover:bg-gold-500/15 transition-colors"
              >
                ...
                <p className="text-gold-600 text-sm font-medium">{tRewards("cartNote")}</p>
              </a>
            )}
