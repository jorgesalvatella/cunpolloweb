  ...
  return (
    <div className="pt-22 sm:pt-24 md:pt-28 pb-12 sm:pb-16">
      <Container className="max-w-4xl">
        <h1 className="text-3xl font-bold text-ink mb-2">{t("termsTitle")}</h1>
        ...
        <div className="prose prose-sm max-w-none text-white/80 space-y-6">
          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.generalTitle")}</h2>
            <p>{t("terms.generalText")}</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.serviceTitle")}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.ordersTitle")}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.paymentsTitle")}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.cancellationsTitle")}</h2>
            <p>{t("terms.cancellationsText")}</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.liabilityTitle")}</h2>
            <p>{t("terms.liabilityText")}</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.ipTitle")}</h2>
            <p>{t("terms.ipText")}</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.modificationsTitle")}</h2>
            <p>{t("terms.modificationsText")}</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.jurisdictionTitle")}</h2>
            <p>{t("terms.jurisdictionText")}</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-ink">{t("terms.contactTitle")}</h2>
            <p>
              {RESTAURANT.name}<br />
