  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-red-300 mb-2">Algo salio mal</h1>
        ...
        <div className="flex flex-col gap-3">
          <button
            onClick={reset}
            className="bg-red-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-red-500 shadow-lg shadow-red-600/25 transition-colors cursor-pointer"
          >
            Intentar de nuevo
          </button>
          <a
